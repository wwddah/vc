...
to_config += f"\ntoken = '{8054916133:AAHixIfODn-gSaiqS_i8BPTX7CkdNnxdr-M}'"
to_config += f"\nDev_Zaid = 8054916133:AAHixIfODn-gSaiqS_i8BPTX7CkdNnxdr-M(':')[0]"
to_config += f"\nsudo_id = {owner_id}"
username = requests.get(f"https://api.telegram.org/bot{8054916133:AAHixIfODn-gSaiqS_i8BPTX7CkdNnxdr-M}/getMe").json()["result"]["username"]
